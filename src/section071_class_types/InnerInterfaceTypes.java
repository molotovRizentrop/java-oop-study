...
public interface InnerInterfaceTypes {
    /** only static inner types in interface **/

    //only static class in interface
    class StaticClass {
    }

    //only static inner interface in interface
    interface Interface {
    }

    //only static inner annotation in interface
    @interface Annotation {
    }

    //only static inner enumeration in interface
    enum Enum {
    }
}
